...
Yagual2024 utiliza técnicas de Machine Learning para reducir los riesgos de la suplantación de identidad digital generados por los Deepfakes. En su propuesta se desarrolla una aplicación web orientada a garantizar la seguridad digital, permitiendo que usuarios sin un conocimiento previo o especializado puedan analizar imágenes (en formatos como JPG, PNG o TIFF) para confirmar su veracidad.
...
Imagen alterada versus región alterada: implicaciones para la formulación del problema
...
Reformulación como tarea de localización y valor forense del overlay
...
Donde: 
 ...
 x representa el valor de entrada proveniente de la capa convolucional
 f(x) corresponde al valor resultante después de aplicar la función de activación.
...
% Sustento conceptual y tecnológico.
% Analizar trabajos previos, metodología, objetivos, resultados,
% limitaciones existentes y diferenciación de la propuesta.
